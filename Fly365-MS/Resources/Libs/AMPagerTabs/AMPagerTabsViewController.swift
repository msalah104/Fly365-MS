...
class AMPagerTabsViewController: UIViewController {
    ...
    private func updateScrollViewsFrames() {
        ...
        tabScrollView.frame = CGRect(x: 0, y: settings.tabsStartPoint, width: self.view.frame.size.width, height: settings.tabHeight)
        containerScrollView.frame = CGRect(x: 0, y: settings.tabHeight + settings.tabsStartPoint, width: self.view.frame.size.width, height: self.view.frame.size.height - settings.tabHeight)
    }
...
class AMSettings{
    ...
    var tabBackgroundColor = #colorLiteral(red: 0.1346258223, green: 0.1712838709, blue: 0.2785593569, alpha: 1)
    var tabButtonColor = #colorLiteral(red: 0.1346258223, green: 0.1712838709, blue: 0.2785593569, alpha: 1)
